...
7. UI renders a risk radar, clause map, adversarial review board, scenario simulation, and negotiation plan.
...
- BigQuery: evaluates aggregate detection accuracy across demo contracts and judge test cases.
